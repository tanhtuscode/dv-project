...
::llvm::LogicalResult DpasOp::verifyInvariantsImpl() {
  ...
  }
  {
    ...
    for (auto v : valueGroup0) {
      if (::mlir::failed(__mlir_ods_local_type_constraint_XeGPU8(*this, v.getType(), "result", index++)))
        return ::mlir::failure();
    }
  }
...
::llvm::LogicalResult InitNbarrierOp::verifyInvariantsImpl() {
  ...
  }
  {
    ...
    for (auto v : valueGroup0) {
      if (::mlir::failed(__mlir_ods_local_type_constraint_XeGPU10(*this, v.getType(), "result", index++)))
        return ::mlir::failure();
    }
  }
  return ::mlir::success();
...
::llvm::LogicalResult LoadGatherOpAdaptor::verify(::mlir::Location loc) {
  ...
  if (tblgen_transpose && !((::llvm::isa<::mlir::UnitAttr>(tblgen_transpose))))
    return emitError(loc, "'xegpu.load' op ""attribute 'transpose' failed to satisfy constraint: unit attribute");
...
::llvm::LogicalResult LoadGatherOp::verifyInherentAttrs(::mlir::OperationName opName, ::mlir::NamedAttrList &attrs, llvm::function_ref<::mlir::InFlightDiagnostic()> emitError) {
...

    {
      ...
      if (attr && ::mlir::failed(__mlir_ods_local_attr_constraint_XeGPU6(attr, "transpose", emitError)))
        return ::mlir::failure();
    }
    return ::mlir::success();
}
...
::llvm::LogicalResult LoadGatherOp::verifyInvariantsImpl() {
  ...
  if (::mlir::failed(__mlir_ods_local_attr_constraint_XeGPU6(*this, tblgen_transpose, "transpose")))
    return ::mlir::failure();
...
::llvm::LogicalResult LoadNdOp::verifyInherentAttrs(::mlir::OperationName opName, ::mlir::NamedAttrList &attrs, llvm::function_ref<::mlir::InFlightDiagnostic()> emitError) {
...

    {
      ...
      if (attr && ::mlir::failed(__mlir_ods_local_attr_constraint_XeGPU6(attr, "packed", emitError)))
        return ::mlir::failure();
    }
...
::llvm::LogicalResult LoadNdOp::verifyInvariantsImpl() {
  ...
  if (::mlir::failed(__mlir_ods_local_attr_constraint_XeGPU6(*this, tblgen_packed, "packed")))
    return ::mlir::failure();
...
::llvm::LogicalResult StoreScatterOpAdaptor::verify(::mlir::Location loc) {
  ...
  if (tblgen_transpose && !((::llvm::isa<::mlir::UnitAttr>(tblgen_transpose))))
    return emitError(loc, "'xegpu.store' op ""attribute 'transpose' failed to satisfy constraint: unit attribute");
