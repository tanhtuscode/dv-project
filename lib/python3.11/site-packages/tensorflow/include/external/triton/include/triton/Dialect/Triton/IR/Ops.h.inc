...
//===----------------------------------------------------------------------===//
// ::mlir::triton::ReinterpretTensorDescOp declarations
//===----------------------------------------------------------------------===//

namespace detail {
class ReinterpretTensorDescOpGenericAdaptorBase {
public:
protected:
  ::mlir::DictionaryAttr odsAttrs;
  ::std::optional<::mlir::OperationName> odsOpName;
  ::mlir::RegionRange odsRegions;
public:
  ReinterpretTensorDescOpGenericAdaptorBase(::mlir::DictionaryAttr attrs = {}, const ::mlir::EmptyProperties &properties = {}, ::mlir::RegionRange regions = {}) : odsAttrs(attrs), odsRegions(regions) {  if (odsAttrs)
      odsOpName.emplace("tt.reinterpret_tensor_descriptor", odsAttrs.getContext());
  }

  ReinterpretTensorDescOpGenericAdaptorBase(::mlir::Operation *op) : odsAttrs(op->getRawDictionaryAttrs()), odsOpName(op->getName()), odsRegions(op->getRegions()) {}
...
template <typename RangeT>
class ReinterpretTensorDescOpGenericAdaptor : public detail::ReinterpretTensorDescOpGenericAdaptorBase {
  using ValueT = ::llvm::detail::ValueOfRange<RangeT>;
  using Base = detail::ReinterpretTensorDescOpGenericAdaptorBase;
public:
  ReinterpretTensorDescOpGenericAdaptor(RangeT values, ::mlir::DictionaryAttr attrs = {}, const ::mlir::EmptyProperties &properties = {}, ::mlir::RegionRange regions = {}) : Base(attrs, properties, regions), odsOperands(values) {}

  ReinterpretTensorDescOpGenericAdaptor(RangeT values, ::mlir::DictionaryAttr attrs, ::mlir::OpaqueProperties properties, ::mlir::RegionRange regions = {}) : ReinterpretTensorDescOpGenericAdaptor(values, attrs, (properties ? *properties.as<::mlir::EmptyProperties *>() : ::mlir::EmptyProperties{}), regions) {}

  ReinterpretTensorDescOpGenericAdaptor(RangeT values, const ReinterpretTensorDescOpGenericAdaptorBase &base) : Base(base), odsOperands(values) {}

  template <typename LateInst = ReinterpretTensorDescOp, typename = std::enable_if_t<std::is_same_v<LateInst, ReinterpretTensorDescOp>>>
  ReinterpretTensorDescOpGenericAdaptor(RangeT values, LateInst op) : Base(op), odsOperands(values) {}
...
class ReinterpretTensorDescOpAdaptor : public ReinterpretTensorDescOpGenericAdaptor<::mlir::ValueRange> {
public:
  using ReinterpretTensorDescOpGenericAdaptor::ReinterpretTensorDescOpGenericAdaptor;
  ReinterpretTensorDescOpAdaptor(ReinterpretTensorDescOp op);

  ::llvm::LogicalResult verify(::mlir::Location loc);
};
class ReinterpretTensorDescOp : public ::mlir::Op<ReinterpretTensorDescOp, ::mlir::OpTrait::ZeroRegions, ::mlir::OpTrait::OneResult, ::mlir::OpTrait::OneTypedResult<::mlir::triton::TensorDescType>::Impl, ::mlir::OpTrait::ZeroSuccessors, ::mlir::OpTrait::OneOperand, ::mlir::OpTrait::OpInvariants, ::mlir::ConditionallySpeculatable::Trait, ::mlir::OpTrait::AlwaysSpeculatableImplTrait, ::mlir::MemoryEffectOpInterface::Trait, ::mlir::OpTrait::TensorSizeTrait, ::mlir::OpTrait::VerifyTensorLayoutsTrait> {
public:
  using Op::Op;
  using Op::print;
  using Adaptor = ReinterpretTensorDescOpAdaptor;
  template <typename RangeT>
  using GenericAdaptor = ReinterpretTensorDescOpGenericAdaptor<RangeT>;
  using FoldAdaptor = GenericAdaptor<::llvm::ArrayRef<::mlir::Attribute>>;
  static ::llvm::ArrayRef<::llvm::StringRef> getAttributeNames() {
    return {};
  }
  ...
  static constexpr ::llvm::StringLiteral getOperationName() {
    return ::llvm::StringLiteral("tt.reinterpret_tensor_descriptor");
  }
  ...
  ::mlir::TypedValue<::mlir::triton::PointerType> getRawDesc() {
    return ::llvm::cast<::mlir::TypedValue<::mlir::triton::PointerType>>(*getODSOperands(0).begin());
  }

  ::mlir::OpOperand &getRawDescMutable() {
  ...
  ::mlir::TypedValue<::mlir::triton::TensorDescType> getResult() {
    return ::llvm::cast<::mlir::TypedValue<::mlir::triton::TensorDescType>>(*getODSResults(0).begin());
  }

  static void build(::mlir::OpBuilder &odsBuilder, ::mlir::OperationState &odsState, ::mlir::Type result, ::mlir::Value rawDesc);
  static void build(::mlir::OpBuilder &odsBuilder, ::mlir::OperationState &odsState, ::mlir::TypeRange resultTypes, ::mlir::Value rawDesc);
  static void build(::mlir::OpBuilder &, ::mlir::OperationState &odsState, ::mlir::TypeRange resultTypes, ::mlir::ValueRange operands, ::llvm::ArrayRef<::mlir::NamedAttribute> attributes = {});
  ::llvm::LogicalResult verifyInvariantsImpl();
  ::llvm::LogicalResult verifyInvariants();
  static ::mlir::ParseResult parse(::mlir::OpAsmParser &parser, ::mlir::OperationState &result);
...
MLIR_DECLARE_EXPLICIT_TYPE_ID(::mlir::triton::ReinterpretTensorDescOp)
...
public:
  ...
  AddPtrOpGenericAdaptor(RangeT values, const AddPtrOpGenericAdaptorBase &base) : Base(base), odsOperands(values) {}
...
public:
  ...
  AdvanceOpGenericAdaptor(RangeT values, const AdvanceOpGenericAdaptorBase &base) : Base(base), odsOperands(values) {}
...
public:
  ...
  static void build(::mlir::OpBuilder &odsBuilder, ::mlir::OperationState &odsState, ::mlir::Value condition, ::mlir::StringAttr message);
  static void build(::mlir::OpBuilder &odsBuilder, ::mlir::OperationState &odsState, ::mlir::TypeRange resultTypes, ::mlir::Value condition, ::mlir::StringAttr message);
  static void build(::mlir::OpBuilder &odsBuilder, ::mlir::OperationState &odsState, ::mlir::Value condition, ::llvm::StringRef message);
  static void build(::mlir::OpBuilder &odsBuilder, ::mlir::OperationState &odsState, ::mlir::TypeRange resultTypes, ::mlir::Value condition, ::llvm::StringRef message);
  static void build(::mlir::OpBuilder &, ::mlir::OperationState &odsState, ::mlir::TypeRange resultTypes, ::mlir::ValueRange operands, ::llvm::ArrayRef<::mlir::NamedAttribute> attributes = {});
  ::llvm::LogicalResult verifyInvariantsImpl();
  ::llvm::LogicalResult verifyInvariants();
  static ::mlir::ParseResult parse(::mlir::OpAsmParser &parser, ::mlir::OperationState &result);
...
public:
  ...
  AtomicCASOpGenericAdaptor(RangeT values, const AtomicCASOpGenericAdaptorBase &base) : Base(base), odsOperands(values) {}
...
public:
  ...
  CatOpGenericAdaptor(RangeT values, const CatOpGenericAdaptorBase &base) : Base(base), odsOperands(values) {}
...
public:
  ...
  ClampFOpGenericAdaptor(RangeT values, const ClampFOpGenericAdaptorBase &base) : Base(base), odsOperands(values) {}
...
//===----------------------------------------------------------------------===//
// ::mlir::triton::DotScaledOp declarations
//===----------------------------------------------------------------------===//
...
public:
  struct Properties {
    ...
    using lhs_typeTy = ::mlir::triton::ScaleDotElemTypeAttr;
    lhs_typeTy lhs_type;

    auto getLhsType() {
      auto &propStorage = this->lhs_type;
      return ::llvm::cast<::mlir::triton::ScaleDotElemTypeAttr>(propStorage);
    }
    void setLhsType(const ::mlir::triton::ScaleDotElemTypeAttr &propValue) {
      this->lhs_type = propValue;
    }
    using rhs_typeTy = ::mlir::triton::ScaleDotElemTypeAttr;
    rhs_typeTy rhs_type;

    auto getRhsType() {
      auto &propStorage = this->rhs_type;
      return ::llvm::cast<::mlir::triton::ScaleDotElemTypeAttr>(propStorage);
    }
    void setRhsType(const ::mlir::triton::ScaleDotElemTypeAttr &propValue) {
      this->rhs_type = propValue;
    }
    ...
    bool operator==(const Properties &rhs) const {
      return 
        ...
        rhs.lhs_type == this->lhs_type &&
        rhs.rhs_type == this->rhs_type &&
...
public:
  DotScaledOpGenericAdaptorBase(::mlir::DictionaryAttr attrs, const Properties &properties, ::mlir::RegionRange regions = {}) : odsAttrs(attrs), properties(properties), odsRegions(regions) {  if (odsAttrs)
      odsOpName.emplace("tt.dot_scaled", odsAttrs.getContext());
  }
  ...
  ::mlir::triton::ScaleDotElemTypeAttr getLhsTypeAttr() {
    auto attr = ::llvm::cast<::mlir::triton::ScaleDotElemTypeAttr>(getProperties().lhs_type);
    return attr;
  }

  ::mlir::triton::ScaleDotElemType getLhsType();
  ::mlir::triton::ScaleDotElemTypeAttr getRhsTypeAttr() {
    auto attr = ::llvm::cast<::mlir::triton::ScaleDotElemTypeAttr>(getProperties().rhs_type);
    return attr;
  }

  ::mlir::triton::ScaleDotElemType getRhsType();
...
public:
  ...
  using Properties = FoldAdaptor::Properties;
  static ::llvm::ArrayRef<::llvm::StringRef> getAttributeNames() {
    static ::llvm::StringRef attrNames[] = {::llvm::StringRef("fastMath"), ::llvm::StringRef("lhs_type"), ::llvm::StringRef("rhs_type"), ::llvm::StringRef("operandSegmentSizes")};
    return ::llvm::ArrayRef(attrNames);
  }
  ...
  ::mlir::StringAttr getLhsTypeAttrName() {
    return getAttributeNameForIndex(1);
  }

  static ::mlir::StringAttr getLhsTypeAttrName(::mlir::OperationName name) {
    return getAttributeNameForIndex(name, 1);
  }

  ::mlir::StringAttr getRhsTypeAttrName() {
    return getAttributeNameForIndex(2);
  }

  static ::mlir::StringAttr getRhsTypeAttrName(::mlir::OperationName name) {
    return getAttributeNameForIndex(name, 2);
  }
  ...
  static constexpr ::llvm::StringLiteral getOperationName() {
    return ::llvm::StringLiteral("tt.dot_scaled");
  }
  ...
  void writeProperties(::mlir::DialectBytecodeWriter &writer);
  ::mlir::triton::ScaleDotElemTypeAttr getLhsTypeAttr() {
    return ::llvm::cast<::mlir::triton::ScaleDotElemTypeAttr>(getProperties().lhs_type);
  }

  ::mlir::triton::ScaleDotElemType getLhsType();
  ::mlir::triton::ScaleDotElemTypeAttr getRhsTypeAttr() {
    return ::llvm::cast<::mlir::triton::ScaleDotElemTypeAttr>(getProperties().rhs_type);
  }
  ...
  bool getFastMath();
  void setLhsTypeAttr(::mlir::triton::ScaleDotElemTypeAttr attr) {
    getProperties().lhs_type = attr;
  }

  void setLhsType(::mlir::triton::ScaleDotElemType attrValue);
  void setRhsTypeAttr(::mlir::triton::ScaleDotElemTypeAttr attr) {
    getProperties().rhs_type = attr;
  }

  void setRhsType(::mlir::triton::ScaleDotElemType attrValue);
  void setFastMathAttr(::mlir::BoolAttr attr) {
    getProperties().fastMath = attr;
  }

  void setFastMath(bool attrValue);
  static void build(::mlir::OpBuilder &odsBuilder, ::mlir::OperationState &odsState, ::mlir::Type d, ::mlir::Value lhs, ::mlir::Value rhs, ::mlir::Value c, /*optional*/::mlir::Value lhs_scale, /*optional*/::mlir::Value rhs_scale, ::mlir::triton::ScaleDotElemTypeAttr lhs_type, ::mlir::triton::ScaleDotElemTypeAttr rhs_type, ::mlir::BoolAttr fastMath);
  ...
  static void build(::mlir::OpBuilder &odsBuilder, ::mlir::OperationState &odsState, ::mlir::Type d, ::mlir::Value lhs, ::mlir::Value rhs, ::mlir::Value c, /*optional*/::mlir::Value lhs_scale, /*optional*/::mlir::Value rhs_scale, ::mlir::triton::ScaleDotElemType lhs_type, ::mlir::triton::ScaleDotElemType rhs_type, bool fastMath);
  static void build(::mlir::OpBuilder &odsBuilder, ::mlir::OperationState &odsState, ::mlir::TypeRange resultTypes, ::mlir::Value lhs, ::mlir::Value rhs, ::mlir::Value c, /*optional*/::mlir::Value lhs_scale, /*optional*/::mlir::Value rhs_scale, ::mlir::triton::ScaleDotElemType lhs_type, ::mlir::triton::ScaleDotElemType rhs_type, bool fastMath);
  static void build(::mlir::OpBuilder &, ::mlir::OperationState &odsState, ::mlir::TypeRange resultTypes, ::mlir::ValueRange operands, ::llvm::ArrayRef<::mlir::NamedAttribute> attributes = {});
  ::llvm::LogicalResult verifyInvariantsImpl();
  ::llvm::LogicalResult verifyInvariants();
  static ::mlir::ParseResult parse(::mlir::OpAsmParser &parser, ::mlir::OperationState &result);
...
MLIR_DECLARE_EXPLICIT_TYPE_ID(::mlir::triton::DotScaledOp)
...
public:
  ...
  ElementwiseInlineAsmOpGenericAdaptor(RangeT values, const ElementwiseInlineAsmOpGenericAdaptorBase &base) : Base(base), odsOperands(values) {}
...
public:
  ...
  ExpandDimsOpGenericAdaptor(RangeT values, const ExpandDimsOpGenericAdaptorBase &base) : Base(base), odsOperands(values) {}
...
public:
  ...
  ExperimentalDescriptorLoadOpGenericAdaptor(RangeT values, const ExperimentalDescriptorLoadOpGenericAdaptorBase &base) : Base(base), odsOperands(values) {}
...
public:
  ...
  static void build(::mlir::OpBuilder &odsBuilder, ::mlir::OperationState &odsState, ::mlir::Type result, ::mlir::Value desc, ::mlir::ValueRange indices, ::mlir::triton::CacheModifierAttr cache, ::mlir::triton::EvictionPolicyAttr evict = nullptr);
  static void build(::mlir::OpBuilder &odsBuilder, ::mlir::OperationState &odsState, ::mlir::TypeRange resultTypes, ::mlir::Value desc, ::mlir::ValueRange indices, ::mlir::triton::CacheModifierAttr cache, ::mlir::triton::EvictionPolicyAttr evict = nullptr);
  static void build(::mlir::OpBuilder &odsBuilder, ::mlir::OperationState &odsState, ::mlir::Type result, ::mlir::Value desc, ::mlir::ValueRange indices, ::mlir::triton::CacheModifier cache = ::mlir::triton::CacheModifier::NONE, ::mlir::triton::EvictionPolicy evict = ::mlir::triton::EvictionPolicy::NORMAL);
  static void build(::mlir::OpBuilder &odsBuilder, ::mlir::OperationState &odsState, ::mlir::TypeRange resultTypes, ::mlir::Value desc, ::mlir::ValueRange indices, ::mlir::triton::CacheModifier cache = ::mlir::triton::CacheModifier::NONE, ::mlir::triton::EvictionPolicy evict = ::mlir::triton::EvictionPolicy::NORMAL);
  static void build(::mlir::OpBuilder &, ::mlir::OperationState &odsState, ::mlir::TypeRange resultTypes, ::mlir::ValueRange operands, ::llvm::ArrayRef<::mlir::NamedAttribute> attributes = {});
  static void populateDefaultProperties(::mlir::OperationName opName, Properties &properties);
  ::llvm::LogicalResult verifyInvariantsImpl();
  ::llvm::LogicalResult verifyInvariants();
...
public:
  ...
  ExperimentalDescriptorStoreOpGenericAdaptor(RangeT values, const ExperimentalDescriptorStoreOpGenericAdaptorBase &base) : Base(base), odsOperands(values) {}
...
public:
  ...
  static void build(::mlir::OpBuilder &odsBuilder, ::mlir::OperationState &odsState, ::mlir::Value desc, ::mlir::Value src, ::mlir::ValueRange indices);
  static void build(::mlir::OpBuilder &odsBuilder, ::mlir::OperationState &odsState, ::mlir::TypeRange resultTypes, ::mlir::Value desc, ::mlir::Value src, ::mlir::ValueRange indices);
  static void build(::mlir::OpBuilder &, ::mlir::OperationState &odsState, ::mlir::TypeRange resultTypes, ::mlir::ValueRange operands, ::llvm::ArrayRef<::mlir::NamedAttribute> attributes = {});
  ::llvm::LogicalResult verifyInvariantsImpl();
  ::llvm::LogicalResult verifyInvariants();
  ::llvm::LogicalResult verify();
...
public:
  ...
  ExperimentalTensormapCreateOpGenericAdaptor(RangeT values, const ExperimentalTensormapCreateOpGenericAdaptorBase &base) : Base(base), odsOperands(values) {}
...
public:
  ...
  ExperimentalTensormapFenceproxyAcquireOpGenericAdaptor(RangeT values, const ExperimentalTensormapFenceproxyAcquireOpGenericAdaptorBase &base) : Base(base), odsOperands(values) {}
...
public:
  ...
  ExternElementwiseOpGenericAdaptor(RangeT values, const ExternElementwiseOpGenericAdaptorBase &base) : Base(base), odsOperands(values) {}
...
public:
  ...
  FpToFpOpGenericAdaptor(RangeT values, const FpToFpOpGenericAdaptorBase &base) : Base(base), odsOperands(values) {}
...
class FpToFpOp : public ::mlir::Op<FpToFpOp, ::mlir::OpTrait::ZeroRegions, ::mlir::OpTrait::OneResult, ::mlir::OpTrait::OneTypedResult<::mlir::Type>::Impl, ::mlir::OpTrait::ZeroSuccessors, ::mlir::OpTrait::OneOperand, ::mlir::OpTrait::OpInvariants, ::mlir::BytecodeOpInterface::Trait, ::mlir::OpTrait::Elementwise, ::mlir::OpTrait::SameOperandsAndResultShape, ::mlir::OpTrait::SameOperandsAndResultEncoding, ::mlir::ConditionallySpeculatable::Trait, ::mlir::OpTrait::AlwaysSpeculatableImplTrait, ::mlir::MemoryEffectOpInterface::Trait, ::mlir::OpTrait::TensorSizeTrait, ::mlir::OpTrait::VerifyTensorLayoutsTrait> {
public:
  using Op::Op;
  using Op::print;
...
//===----------------------------------------------------------------------===//
// ::mlir::triton::GatherOp declarations
//===----------------------------------------------------------------------===//
...
public:
  GatherOpGenericAdaptorBase(::mlir::DictionaryAttr attrs, const Properties &properties, ::mlir::RegionRange regions = {}) : odsAttrs(attrs), properties(properties), odsRegions(regions) {  if (odsAttrs)
      odsOpName.emplace("tt.gather", odsAttrs.getContext());
  }
...
public:
  ...
  using Properties = FoldAdaptor::Properties;
  static ::llvm::ArrayRef<::llvm::StringRef> getAttributeNames() {
    static ::llvm::StringRef attrNames[] = {::llvm::StringRef("axis"), ::llvm::StringRef("efficient_layout")};
    return ::llvm::ArrayRef(attrNames);
  }
  ...
  static constexpr ::llvm::StringLiteral getOperationName() {
    return ::llvm::StringLiteral("tt.gather");
  }
  ...
  static void build(::mlir::OpBuilder &odsBuilder, ::mlir::OperationState &odsState, ::mlir::Type result, ::mlir::Value src, ::mlir::Value indices, ::mlir::IntegerAttr axis, /*optional*/::mlir::UnitAttr efficient_layout = nullptr);
  static void build(::mlir::OpBuilder &odsBuilder, ::mlir::OperationState &odsState, ::mlir::Value src, ::mlir::Value indices, ::mlir::IntegerAttr axis, /*optional*/::mlir::UnitAttr efficient_layout = nullptr);
  static void build(::mlir::OpBuilder &odsBuilder, ::mlir::OperationState &odsState, ::mlir::TypeRange resultTypes, ::mlir::Value src, ::mlir::Value indices, ::mlir::IntegerAttr axis, /*optional*/::mlir::UnitAttr efficient_layout = nullptr);
  static void build(::mlir::OpBuilder &odsBuilder, ::mlir::OperationState &odsState, ::mlir::Type result, ::mlir::Value src, ::mlir::Value indices, uint32_t axis, /*optional*/bool efficient_layout = false);
  static void build(::mlir::OpBuilder &odsBuilder, ::mlir::OperationState &odsState, ::mlir::Value src, ::mlir::Value indices, uint32_t axis, /*optional*/bool efficient_layout = false);
  static void build(::mlir::OpBuilder &odsBuilder, ::mlir::OperationState &odsState, ::mlir::TypeRange resultTypes, ::mlir::Value src, ::mlir::Value indices, uint32_t axis, /*optional*/bool efficient_layout = false);
  static void build(::mlir::OpBuilder &, ::mlir::OperationState &odsState, ::mlir::TypeRange resultTypes, ::mlir::ValueRange operands, ::llvm::ArrayRef<::mlir::NamedAttribute> attributes = {});
  static void build(::mlir::OpBuilder &odsBuilder, ::mlir::OperationState &odsState, ::mlir::ValueRange operands, ::llvm::ArrayRef<::mlir::NamedAttribute> attributes = {});
  ::llvm::LogicalResult verifyInvariantsImpl();
  ::llvm::LogicalResult verifyInvariants();
...
MLIR_DECLARE_EXPLICIT_TYPE_ID(::mlir::triton::GatherOp)
...
public:
  ...
  GetNumProgramsOpGenericAdaptor(RangeT values, const GetNumProgramsOpGenericAdaptorBase &base) : Base(base), odsOperands(values) {}
...
public:
  ...
  static void build(::mlir::OpBuilder &odsBuilder, ::mlir::OperationState &odsState, int axis);
...
public:
  ...
  GetProgramIdOpGenericAdaptor(RangeT values, const GetProgramIdOpGenericAdaptorBase &base) : Base(base), odsOperands(values) {}
...
public:
  ...
  HistogramOpGenericAdaptor(RangeT values, const HistogramOpGenericAdaptorBase &base) : Base(base), odsOperands(values) {}
...
public:
  ...
  JoinOpGenericAdaptor(RangeT values, const JoinOpGenericAdaptorBase &base) : Base(base), odsOperands(values) {}
...
public:
  ...
  MakeRangeOpGenericAdaptor(RangeT values, const MakeRangeOpGenericAdaptorBase &base) : Base(base), odsOperands(values) {}
...
//===----------------------------------------------------------------------===//
// ::mlir::triton::MakeTensorDescOp declarations
//===----------------------------------------------------------------------===//

namespace detail {
class MakeTensorDescOpGenericAdaptorBase {
public:
protected:
  ::mlir::DictionaryAttr odsAttrs;
  ::std::optional<::mlir::OperationName> odsOpName;
  ::mlir::RegionRange odsRegions;
public:
  MakeTensorDescOpGenericAdaptorBase(::mlir::DictionaryAttr attrs = {}, const ::mlir::EmptyProperties &properties = {}, ::mlir::RegionRange regions = {}) : odsAttrs(attrs), odsRegions(regions) {  if (odsAttrs)
      odsOpName.emplace("tt.make_tensor_descriptor", odsAttrs.getContext());
  }

  MakeTensorDescOpGenericAdaptorBase(::mlir::Operation *op) : odsAttrs(op->getRawDictionaryAttrs()), odsOpName(op->getName()), odsRegions(op->getRegions()) {}
...
template <typename RangeT>
class MakeTensorDescOpGenericAdaptor : public detail::MakeTensorDescOpGenericAdaptorBase {
  using ValueT = ::llvm::detail::ValueOfRange<RangeT>;
  using Base = detail::MakeTensorDescOpGenericAdaptorBase;
public:
  MakeTensorDescOpGenericAdaptor(RangeT values, ::mlir::DictionaryAttr attrs = {}, const ::mlir::EmptyProperties &properties = {}, ::mlir::RegionRange regions = {}) : Base(attrs, properties, regions), odsOperands(values) {}

  MakeTensorDescOpGenericAdaptor(RangeT values, ::mlir::DictionaryAttr attrs, ::mlir::OpaqueProperties properties, ::mlir::RegionRange regions = {}) : MakeTensorDescOpGenericAdaptor(values, attrs, (properties ? *properties.as<::mlir::EmptyProperties *>() : ::mlir::EmptyProperties{}), regions) {}

  MakeTensorDescOpGenericAdaptor(RangeT values, const MakeTensorDescOpGenericAdaptorBase &base) : Base(base), odsOperands(values) {}

  template <typename LateInst = MakeTensorDescOp, typename = std::enable_if_t<std::is_same_v<LateInst, MakeTensorDescOp>>>
  MakeTensorDescOpGenericAdaptor(RangeT values, LateInst op) : Base(op), odsOperands(values) {}
...
class MakeTensorDescOpAdaptor : public MakeTensorDescOpGenericAdaptor<::mlir::ValueRange> {
public:
  using MakeTensorDescOpGenericAdaptor::MakeTensorDescOpGenericAdaptor;
  MakeTensorDescOpAdaptor(MakeTensorDescOp op);

  ::llvm::LogicalResult verify(::mlir::Location loc);
};
class MakeTensorDescOp : public ::mlir::Op<MakeTensorDescOp, ::mlir::OpTrait::ZeroRegions, ::mlir::OpTrait::OneResult, ::mlir::OpTrait::OneTypedResult<::mlir::triton::TensorDescType>::Impl, ::mlir::OpTrait::ZeroSuccessors, ::mlir::OpTrait::AtLeastNOperands<1>::Impl, ::mlir::OpTrait::OpInvariants, ::mlir::ConditionallySpeculatable::Trait, ::mlir::OpTrait::AlwaysSpeculatableImplTrait, ::mlir::MemoryEffectOpInterface::Trait, ::mlir::OpTrait::TensorSizeTrait, ::mlir::OpTrait::VerifyTensorLayoutsTrait> {
public:
  using Op::Op;
  using Op::print;
  using Adaptor = MakeTensorDescOpAdaptor;
  template <typename RangeT>
  using GenericAdaptor = MakeTensorDescOpGenericAdaptor<RangeT>;
  using FoldAdaptor = GenericAdaptor<::llvm::ArrayRef<::mlir::Attribute>>;
  static ::llvm::ArrayRef<::llvm::StringRef> getAttributeNames() {
    return {};
  }
  ...
  static constexpr ::llvm::StringLiteral getOperationName() {
    return ::llvm::StringLiteral("tt.make_tensor_descriptor");
  }
  ...
  static void build(::mlir::OpBuilder &odsBuilder, ::mlir::OperationState &odsState, Value base, ValueRange shape, ValueRange strides, ArrayRef<int32_t> blockShape);
  static void build(::mlir::OpBuilder &odsBuilder, ::mlir::OperationState &odsState, ::mlir::Type result, ::mlir::Value base, ::mlir::ValueRange shape, ::mlir::ValueRange strides);
  static void build(::mlir::OpBuilder &odsBuilder, ::mlir::OperationState &odsState, ::mlir::TypeRange resultTypes, ::mlir::Value base, ::mlir::ValueRange shape, ::mlir::ValueRange strides);
  static void build(::mlir::OpBuilder &, ::mlir::OperationState &odsState, ::mlir::TypeRange resultTypes, ::mlir::ValueRange operands, ::llvm::ArrayRef<::mlir::NamedAttribute> attributes = {});
  ::llvm::LogicalResult verifyInvariantsImpl();
  ::llvm::LogicalResult verifyInvariants();
  static ::mlir::ParseResult parse(::mlir::OpAsmParser &parser, ::mlir::OperationState &result);
...
MLIR_DECLARE_EXPLICIT_TYPE_ID(::mlir::triton::MakeTensorDescOp)
...
public:
  ...
  MakeTensorPtrOpGenericAdaptor(RangeT values, const MakeTensorPtrOpGenericAdaptorBase &base) : Base(base), odsOperands(values) {}
...
public:
  ...
  MulhiUIOpGenericAdaptor(RangeT values, const MulhiUIOpGenericAdaptorBase &base) : Base(base), odsOperands(values) {}
...
public:
  ...
  PreciseDivFOpGenericAdaptor(RangeT values, const PreciseDivFOpGenericAdaptorBase &base) : Base(base), odsOperands(values) {}
...
public:
  ...
  PreciseSqrtOpGenericAdaptor(RangeT values, const PreciseSqrtOpGenericAdaptorBase &base) : Base(base), odsOperands(values) {}
...
public:
  struct Properties {
    using allow_reorderTy = ::mlir::UnitAttr;
    ...
    void setAllowReorder(const ::mlir::UnitAttr &propValue) {
...
public:
  ...
  ::mlir::UnitAttr getAllowReorderAttr();
...
public:
  ...
  void writeProperties(::mlir::DialectBytecodeWriter &writer);
  ::mlir::UnitAttr getAllowReorderAttr() {
    return ::llvm::dyn_cast_or_null<::mlir::UnitAttr>(getProperties().allow_reorder);
  }
  ...
  bool getEfficientLayout();
  void setAllowReorderAttr(::mlir::UnitAttr attr) {
  ...
  void setEfficientLayout(bool attrValue);
  ::mlir::Attribute removeAllowReorderAttr() {
      auto &attr = getProperties().allow_reorder;
      attr = {};
      return attr;
  }
  ...
  static void build(::mlir::OpBuilder &odsBuilder, ::mlir::OperationState &odsState, ::mlir::Type result, ::mlir::Value src, /*optional*/::mlir::UnitAttr allow_reorder, /*optional*/::mlir::UnitAttr efficient_layout = nullptr);
  static void build(::mlir::OpBuilder &odsBuilder, ::mlir::OperationState &odsState, ::mlir::TypeRange resultTypes, ::mlir::Value src, /*optional*/::mlir::UnitAttr allow_reorder, /*optional*/::mlir::UnitAttr efficient_layout = nullptr);
  static void build(::mlir::OpBuilder &odsBuilder, ::mlir::OperationState &odsState, ::mlir::Type result, ::mlir::Value src, /*optional*/bool allow_reorder = false, /*optional*/bool efficient_layout = false);
  static void build(::mlir::OpBuilder &odsBuilder, ::mlir::OperationState &odsState, ::mlir::TypeRange resultTypes, ::mlir::Value src, /*optional*/bool allow_reorder = false, /*optional*/bool efficient_layout = false);
  static void build(::mlir::OpBuilder &, ::mlir::OperationState &odsState, ::mlir::TypeRange resultTypes, ::mlir::ValueRange operands, ::llvm::ArrayRef<::mlir::NamedAttribute> attributes = {});
  ::llvm::LogicalResult verifyInvariantsImpl();
  ::llvm::LogicalResult verifyInvariants();
  ::llvm::LogicalResult verify();
...
public:
  ...
  ScanReturnOpGenericAdaptor(RangeT values, const ScanReturnOpGenericAdaptorBase &base) : Base(base), odsOperands(values) {}
...
public:
  ...
  SplitOpGenericAdaptor(RangeT values, const SplitOpGenericAdaptorBase &base) : Base(base), odsOperands(values) {}
...
public:
  ...
  TransOpGenericAdaptor(RangeT values, const TransOpGenericAdaptorBase &base) : Base(base), odsOperands(values) {}
...
class TransOp : public ::mlir::Op<TransOp, ::mlir::OpTrait::ZeroRegions, ::mlir::OpTrait::OneResult, ::mlir::OpTrait::OneTypedResult<::mlir::RankedTensorType>::Impl, ::mlir::OpTrait::ZeroSuccessors, ::mlir::OpTrait::OneOperand, ::mlir::OpTrait::OpInvariants, ::mlir::BytecodeOpInterface::Trait, ::mlir::ConditionallySpeculatable::Trait, ::mlir::OpTrait::AlwaysSpeculatableImplTrait, ::mlir::MemoryEffectOpInterface::Trait, ::mlir::triton::TransposeOpInterface::Trait, ::mlir::InferTypeOpInterface::Trait, ::mlir::OpTrait::InferTypeOpAdaptor, ::mlir::OpTrait::SameOperandsAndResultElementType, ::mlir::OpTrait::TensorSizeTrait, ::mlir::OpTrait::VerifyTensorLayoutsTrait> {
public:
  using Op::Op;
  using Op::print;
